...
-- ----------------------------
BEGIN;
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('0f12b51c-517c-4ff9-9bba-0b32fd2f31ed', '', 1753889892311, '', 1753889892311, 'Information', 'otherTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('2f5ae214-ad8b-4c6e-9c64-4ce753804e9c', '', 1753889892350, '', 1753889892350, 'AutoGenStrIdSoftDel', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('3492dad6-0e4b-40f0-aa5e-1a9dcb5077c9', '', 1753889892488, '', 1753889892488, 'Menu', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('375fdf87-f0e6-420a-a038-b545e1a3a6e4', '', 1753889892360, '', 1753889892360, 'Role', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('5e0d58dd-2a5e-4129-9549-3ca491498dbf', '', 1753889892446, '', 1753889892446, 'MenuRole', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('6043ae00-bf87-4c91-9f10-26c8a6b257c4', '', 1753889892392, '', 1753889892392, 'UserFavorite', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('6ed4e075-0fed-4dee-b97a-74080568eeeb', '', 1753889892470, '', 1753889892470, 'UserDetail', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('81d90a80-7c79-4e7e-b9b9-464de7e69959', '', 1753889892371, '', 1753889892371, 'LongIdJoinComposite', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('824afa1c-0858-4426-9afa-fcdc9733daa5', '', 1753889892521, '', 1753889892521, 'Information', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('8e878976-3ccb-42aa-b8d4-142b20153de1', '', 1753889892283, '', 1753889892283, 'CompositeHardDel', 'otherTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('9f76ccf2-83bd-4229-b8d0-dd1e5da06e5c', '', 1753889892431, '', 1753889892431, 'EmbeddedWithoutAttribute', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('b3ba314a-4ee9-4b83-86d9-1e01b35e41e2', '', 1753889892335, '', 1753889892335, 'AutoGenLongIdHardDel', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('b565d6b6-e038-4aee-9a18-b94e6807e794', '', 1753889892283, '', 1753889892283, 'EmbeddedSoftDel', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('bc6f7fec-cfae-4bb9-92eb-4d8085594230', '', 1753889892511, '', 1753889892511, 'AutoGenStrIdHardDel', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('bee05f79-3778-4477-9464-e13b2c5a4ef6', '', 1753889892498, '', 1753889892498, 'EmbeddedHardDel', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('ca2519ff-8bfc-4d1b-b385-900e80c4a3b5', '', 1753889892477, '', 1753889892477, 'InformationLink', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('cbf27e91-7efa-492d-b8ef-4cb440c37ac9', '', 1753889892322, '', 1753889892322, 'User', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('d13725f9-9213-4c8a-a3cf-d9edf44279f6', '', 1753889892458, '', 1753889892458, 'ManualGenStrIdSoftDel', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('d36d7d47-c2be-4279-881d-faa6c6448b7d', '', 1753889892310, '', 1753889892310, 'LongIdJoinEmbedded', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('e114c28b-bd3e-4487-ba79-bbabb57bc8c7', '', 1753889892381, '', 1753889892381, 'IntegerIdWithBytes', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('f66714a8-6bf0-4590-8bc5-891e3a0262c9', '', 1753889892421, '', 1753889892421, 'CompositeSoftDel', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('fc951e05-c4db-42a6-814b-bc76c374bd6a', '', 1753889892406, '', 1753889892406, 'CompositeHardDel', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `api_item_request` (`item_id`, `class_name`, `consumes`, `function_name`, `methods`, `package_name`, `parameter_count`, `patterns`, `produces`) VALUES ('87fa6349-87e3-47fd-8056-b651dd214c66', 'MenuController', '', 'list', 'GET', 'net.ideahut.springboot.template.controller', 0, '/menu/list', '');
INSERT INTO `api_item_request` (`item_id`, `class_name`, `consumes`, `function_name`, `methods`, `package_name`, `parameter_count`, `patterns`, `produces`) VALUES ('daa0f77a-0bd3-4d6e-9b32-0e93e38b0fab', 'DevController', '', 'receive', 'POST', 'net.ideahut.springboot.template.controller', 2, '/dev/multipart', '');
COMMIT;
