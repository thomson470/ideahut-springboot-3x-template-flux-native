...
-- ----------------------------
BEGIN;
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('064bdefe-c11c-4597-a4f5-f68e222b1287', '', 1740765311732, '', 1740765311732, 'InformationLink', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('18c9c57c-eb54-4d05-8a08-8a2f5df2824d', '', 1740765311642, '', 1740765311642, 'LongIdJoinEmbedded', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('231c50f7-e104-44aa-9672-6db46c28e9de', '', 1740765311755, '', 1740765311755, 'CompositeHardDel', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('26c7ba56-e24f-4f34-b2ff-07b0bf52c493', '', 1740765311786, '', 1740765311786, 'Information', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('28861c24-3305-475f-b2a4-4da5e9cb8506', '', 1740765311702, '', 1740765311702, 'EmbeddedHardDel', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('345b427d-b529-44df-b34d-8f38b25c2667', '', 1740765311563, '', 1740765311563, 'Information', 'otherTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('4110c9e5-627c-46dd-8688-42cc25bdafef', '', 1740765311713, '', 1740765311713, 'User', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('4144b399-e520-4074-a6b4-e1974291d44c', '', 1740765311667, '', 1740765311667, 'IntegerIdWithBytes', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('54dc0948-c141-4192-982e-bd97d69c513e', '', 1740765311776, '', 1740765311776, 'ManualGenStrIdSoftDel', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('59a20270-c937-4325-a49b-f581b9b1b81e', '', 1740765311816, '', 1740765311816, 'Menu', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('685a63e4-27ff-472f-8a58-5190f86019a7', '', 1740765311679, '', 1740765311679, 'AutoGenLongIdHardDel', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('833b0175-4e85-41f4-8edc-8377dac096cb', '', 1740765311693, '', 1740765311693, 'CompositeSoftDel', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('833f59de-e941-4311-a297-5c620615a16a', '', 1740765311766, '', 1740765311766, 'UserFavorite', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('8c007cbe-998b-445e-8509-241fdcd4c124', '', 1740765311724, '', 1740765311724, 'Role', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('a168f701-37ad-40de-8d5e-c840a617195b', '', 1740765311618, '', 1740765311618, 'CompositeHardDel', 'otherTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('b4cebde3-35c4-41bc-82af-60c80941cfcb', '', 1740765311745, '', 1740765311745, 'LongIdJoinComposite', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('ba5c92de-98d7-4354-a3b1-639bfeb54c90', '', 1740765311796, '', 1740765311796, 'AutoGenStrIdHardDel', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('be5ad838-13e8-498a-b99b-13a631302e08', '', 1740765311599, '', 1740765311599, 'AutoGenStrIdSoftDel', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('cbfa2cb9-235a-420d-9154-e83f2d0a1328', '', 1740765311826, '', 1740765311826, 'MenuRole', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('d4cbe069-1a69-481e-a1fb-349bd34bb0d7', '', 1740765311805, '', 1740765311805, 'EmbeddedSoftDel', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('da0efda3-ae94-4a00-9358-08139722641b', '', 1740765311653, '', 1740765311653, 'EmbeddedWithoutAttribute', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
INSERT INTO `api_item_crud` (`item_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `class_name`, `manager`, `package_name`) VALUES ('f56b3859-5f92-401f-bc26-aa39fff52748', '', 1740765311627, '', 1740765311627, 'UserDetail', 'mainTransactionManager', 'net.ideahut.springboot.template.entity.app');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `api_item_request` (`item_id`, `class_name`, `consumes`, `function_name`, `methods`, `package_name`, `parameter_count`, `patterns`, `produces`) VALUES ('36fa8b22-da74-4dc7-bb81-cf73168cf8c7', 'DevController', '', 'receive', 'POST', 'net.ideahut.springboot.template.controller', 2, '/dev/multipart', '');
INSERT INTO `api_item_request` (`item_id`, `class_name`, `consumes`, `function_name`, `methods`, `package_name`, `parameter_count`, `patterns`, `produces`) VALUES ('5c4486a0-81e2-4e62-b9d2-494624cc0c53', 'MenuController', '', 'list', 'GET', 'net.ideahut.springboot.template.controller', 0, '/menu/list', '');
INSERT INTO `api_item_request` (`item_id`, `class_name`, `consumes`, `function_name`, `methods`, `package_name`, `parameter_count`, `patterns`, `produces`) VALUES ('7220c4be-69d7-4a29-829b-2393776a171d', 'AuthController', '', 'logout', 'GET,POST', 'net.ideahut.springboot.template.controller', 1, '/auth/logout', '');
INSERT INTO `api_item_request` (`item_id`, `class_name`, `consumes`, `function_name`, `methods`, `package_name`, `parameter_count`, `patterns`, `produces`) VALUES ('a0a947e5-c61e-4903-a9b0-acd5c83e02a0', 'AuthController', '', 'info', 'GET,POST', 'net.ideahut.springboot.template.controller', 1, '/auth/info', '');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `information_2` (`information_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `content`, `description`, `image`, `is_active`, `is_external`, `seqno`, `title`, `url`) VALUES ('INF2025-103017-0059-09975-25200-0003', 'ROLE::PUBLIC', 1740765549981, 'ROLE::PUBLIC', 1740765593032, NULL, 'description (edited2)', 'A', 'Y', 'N', 1, 'admin', NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `information_link_2` (`link_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `code`, `label`, `seqno`, `target`, `information_id`) VALUES ('2025-103017-0059-10187-25200-0004', 'ROLE::PUBLIC', 1740765550190, 'ROLE::PUBLIC', 1740765593076, 'code1', 'label (edited)', 3, 'target', 'INF2025-103017-0059-09975-25200-0003');
INSERT INTO `information_link_2` (`link_id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `code`, `label`, `seqno`, `target`, `information_id`) VALUES ('2025-103017-0059-10288-25200-0005', 'ROLE::PUBLIC', 1740765550290, 'ROLE::PUBLIC', 1740765593111, 'code2', 'label (edited)--', 2, 'target', 'INF2025-103017-0059-09975-25200-0003');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `manual_gen_str_id_soft_del` (`id`, `created_by`, `created_on`, `updated_by`, `updated_on`, `deleted_on`, `description`, `is_active`, `name`) VALUES ('yyy444', 'ROLE::PUBLIC', 1740765803275, 'ROLE::PUBLIC', 1740765829213, 1740765829213, 'description', 'Y', 'yyyyyTest (Edited)');
COMMIT;
